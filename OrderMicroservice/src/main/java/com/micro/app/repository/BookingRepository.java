...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    public void addTableToBookingForUser(@Param("bookingId") Integer booking_id,
    ...
    public void deleteTableToBookingForUser(@Param("bookingId") Integer booking_id,
                                            @Param("tableId") Integer table_id);
    ...
    public void deleteFoodToTableToBookingForUser(@Param("bookedTableId") Integer bookedTableId,
                                                  @Param("foodId") Integer foodId);
}
